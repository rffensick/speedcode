...
$(function(){$("#my-menu").mmenu({navbar:{title:"speedcode"},navbars:[{position:"bottom",content:["<a class='fa fa-whatsapp' href=''></a>","<a class='fa fa-telegram' href='https://telegram.me/vsvpxe'></a>","<a class='fa fa-vk' href='https://vk.com'></a>"]}],extensions:["theme-dark","pagedim-black"],offCanvas:{position:"top",zposition:"top"},autoHeight:!0}),$("#my-menu").data("mmenu").bind("open:start",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".popup-gmaps").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1}),$(window).on("load",function(){setTimeout(function(){$(".preloader").fadeOut("slow",function(){})},2e3)})});